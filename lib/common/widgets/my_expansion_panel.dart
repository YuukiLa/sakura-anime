...
class ExpansionPanelRadio extends MyExpansionPanel {
...
class _ExpansionPanelListState extends State<MyExpansionPanelList> {
        ...
        children: <Widget>[
          Expanded(
            child: AnimatedContainer(
              ...
              margin: EdgeInsets.zero,//_isChildExpanded(index) ? widget.expandedHeaderPadding : EdgeInsets.zero,
              child: headerWidget//ConstrainedBox(
