...
GlobalKey<_MyExpansionTileState> globalKey = GlobalKey();
class MyExpansionTile extends StatefulWidget {
  ...
  @override
  createState() => _MyExpansionTileState();
}
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              onTap: _handleTap,
              contentPadding: EdgeInsets.zero,//widget.tilePadding ?? expansionTileTheme.tilePadding,
